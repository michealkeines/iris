...
use crate::NetworkLayer::body::ResponseBody;
#[cfg(feature = "cookies")]
use crate::cookie;
...
impl<T: Into<Body>> From<http::Response<T>> for Response {
    fn from(r: http::Response<T>) -> Response {
        use crate::NetworkLayer::response::ResponseUrl;

        let (mut parts, body) = r.into_parts();
        let body: crate::NetworkLayer::body::Body = body.into();
        let decoder = Decoder::detect(
            &mut parts.headers,
...
/*
 just some addtion for ResponseBuilder, so that it will be easier to add URL to response
*/
